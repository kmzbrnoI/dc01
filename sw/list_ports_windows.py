...
# See https://github.com/pyserial/pyserial/pull/338
# Source of file: https://github.com/GermainHebert/pyserial/blob/master/serial/tools/list_ports_windows.py
# It incorporates reading of bus-reported-name on Windows
